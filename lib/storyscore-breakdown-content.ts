...
export function buildStoryscoreBreakdownText({
  ...
  return [
    ...
    "STORYSCORE CARD",
    "",
    `CENTER: ${core.name.toUpperCase()}`,
    `VIBE: ${balance.name.toUpperCase()}`,
    `TWIST: ${inverse.name.toUpperCase()}`,
    "",
    "WHAT THIS MEANS:",
    "",
    chordOneLiner,
    ...
    "",
    formatArchetypeSection("YOUR CENTER", coreId, "core"),
    "",
    formatArchetypeSection("YOUR VIBE", balanceId, "balance"),
    "",
    formatArchetypeSection("YOUR TWIST", inverseId, "inverse"),
    "",
